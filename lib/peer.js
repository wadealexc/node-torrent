...
class Peer extends EventEmitter {
    ...
    _readAndProcessMessages() {
        debug('%s | entered main loop. %d unread', this, this.getUnreadSize());
    ...
    _readPiece(message) {
        ...
        debug('%s | read %d bytes of piece #%d to buff[%d:%d] of total %d', this, data.length, index, offset, offset + data.length, this.currentPiece.size);
    ...
    _sendRequest() {
        ...
        debug('%s | requesting %d bytes of piece #%d to offset %d of total %d', this, amount, index, offset, this.currentPiece.size);
